...
__name(processSongUpdate, "processSongUpdate");
...
function calculateScorePoint({ difficulty, achievements, options }) {
  ...
  const option = hasAtLeastSSS ? normalizeSpecialOptions(options).reduce((sum, key) => sum + (SPECIAL_OPTION_POINTS[key] ?? 0), 0) : 0;
...
__name(normalizeSpecialOptions, "normalizeSpecialOptions");
...
__name(getSelectedSpecialOptions, "getSelectedSpecialOptions");
...
__name(normalizeAchievementLabel, "normalizeAchievementLabel");
...
__name(normalizeSpecialOptionLabel, "normalizeSpecialOptionLabel");
...
__name(formatSubmitSelection, "formatSubmitSelection");
...
__name(formatAchievementLabel, "formatAchievementLabel");
...
__name(formatSpecialOptionLabel, "formatSpecialOptionLabel");
...
__name(isValidOmikuziLevel, "isValidOmikuziLevel");
...
__name(formatMaimaiVersion, "formatMaimaiVersion");
